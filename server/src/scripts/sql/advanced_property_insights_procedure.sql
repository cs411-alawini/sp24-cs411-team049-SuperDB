...
BEGIN
   ...
   DECLARE percentileValue INT DEFAULT 0;
   ...
   GROUP BY PropertyID;
    ...
    SELECT FavoriteCount INTO percentileValue FROM FavoriteAnalysis ORDER BY FavoriteCount LIMIT 1;
   ...
   insights_loop: LOOP
       ...
       SELECT
           ...
           r.AvgRating,
           CASE
               WHEN r.AvgRating >= 4 AND f.FavoriteCount >= percentileValue THEN 'Highly recommended'
